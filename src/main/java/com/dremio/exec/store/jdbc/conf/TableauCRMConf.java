...
@SourceType(value = "TableauCRMARP", label = "TableauCRM",uiConfig = "tableaucrm-layout.json")
public class TableauCRMConf extends AbstractArpConf<TableauCRMConf> {
  private static final String ARP_FILENAME = "arp/implementation/tableaucrm-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.tableaucrm.TableauCRMDriver";
